...
var OpenSeaPort = /** @class */ (function () {
    ...
    // new func
    OpenSeaPort.prototype.createAtomicMatchData = function (_a) {
        var order = _a.order, accountAddress = _a.accountAddress, recipientAddress = _a.recipientAddress, referrerAddress = _a.referrerAddress;
        return __awaiter(this, void 0, void 0, function () {
            var matchingOrder, _b, buy, sell, metadata, data;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        matchingOrder = this._makeMatchingOrder({
                        ...
                        _b = utils_1.assignOrdersToSides(order, matchingOrder), buy = _b.buy, sell = _b.sell;
                        metadata = this._getMetadata(order, referrerAddress);
                        return [4 /*yield*/, this._createAtomicMatchParams({ buy: buy, sell: sell, accountAddress: accountAddress, metadata: metadata })];
                    case 1:
                        data = _c.sent();
                        return [2 /*return*/, { data: data, buyOrder: buy }];
                }
            });
        });
    };
    // new func
    OpenSeaPort.prototype.createApproveOrderData = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var accountAddress, includeInOrderBook, data;
            return __generator(this, function (_a) {
                accountAddress = order.maker;
                includeInOrderBook = true;
                this._dispatch(types_1.EventType.ApproveOrder, { order: order, accountAddress: accountAddress });
                data = this._wyvernProtocol.wyvernExchange.approveOrder_.getABIEncodedTransactionData([order.exchange, order.maker, order.taker, order.feeRecipient, order.target, order.staticTarget, order.paymentToken], [order.makerRelayerFee, order.takerRelayerFee, order.makerProtocolFee, order.takerProtocolFee, order.basePrice, order.extra, order.listingTime, order.expirationTime, order.salt], order.feeMethod, order.side, order.saleKind, order.howToCall, order.calldata, order.replacementPattern, order.staticExtradata, includeInOrderBook);
     ...
     * @param schemaName The Wyvern schema name corresponding to the asset type
     */
    OpenSeaPort.prototype.createSellOrderWithoutSignature = function (_a) {
        var tokenId = _a.tokenId, tokenAddress = _a.tokenAddress, asset = _a.asset, accountAddress = _a.accountAddress, listingTime = _a.listingTime, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.quantity, quantity = _b === void 0 ? 1 : _b, _c = _a.expirationTime, expirationTime = _c === void 0 ? 0 : _c, _d = _a.waitForHighestBid, waitForHighestBid = _d === void 0 ? false : _d, paymentTokenAddress = _a.paymentTokenAddress, _e = _a.extraBountyBasisPoints, extraBountyBasisPoints = _e === void 0 ? 0 : _e, buyerAddress = _a.buyerAddress, buyerEmail = _a.buyerEmail, _f = _a.schemaName, schemaName = _f === void 0 ? types_1.WyvernSchemaName.ERC721 : _f, makerRelayerFee = _a.makerRelayerFee, takerRelayerFee = _a.takerRelayerFee, makerProtocolFee = _a.makerProtocolFee, takerProtocolFee = _a.takerProtocolFee, makerReferrerFee = _a.makerReferrerFee;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        order = _g.sent();
                        order.listingTime = utils_1.makeBigNumber(listingTime);
                        order.expirationTime = utils_1.makeBigNumber(0);
                        order.salt = utils_1.makeBigNumber(1);
                        // Modify fee if given
                        // makerRelayerFee,
                        // takerRelayerFee,
                        ...
                        if (makerRelayerFee != 0 && makerRelayerFee) {
                            order.makerRelayerFee = utils_1.makeBigNumber(makerRelayerFee);
                        }
                        if (takerRelayerFee != 0 && takerRelayerFee) {
                            order.takerRelayerFee = utils_1.makeBigNumber(takerRelayerFee);
                        }
                        if (makerProtocolFee != 0 && makerProtocolFee) {
                            order.makerProtocolFee = utils_1.makeBigNumber(makerProtocolFee);
                        }
                        if (takerProtocolFee != 0 && takerProtocolFee) {
                            order.takerProtocolFee = utils_1.makeBigNumber(takerProtocolFee);
                        }
                        if (makerReferrerFee != 0 && makerReferrerFee) {
                            order.makerReferrerFee = utils_1.makeBigNumber(makerReferrerFee);
                        }
                        hashedOrder = __assign({}, order, { hash: utils_1.getOrderHash(order) });
    ...
    OpenSeaPort.prototype._createAtomicMatchParams = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? utils_1.NULL_BLOCK_HASH : _b;
        return __awaiter(this, void 0, void 0, function () {
            var shouldValidateBuy, shouldValidateSell, args, data;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        shouldValidateBuy = true;
                    ...
                    case 3:
                        ...
                        shouldValidateBuy = false;
                        return [3 /*break*/, 4];
                    case 4: return [4 /*yield*/, this._validateMatch({ buy: buy, sell: sell, accountAddress: accountAddress, shouldValidateBuy: shouldValidateBuy, shouldValidateSell: shouldValidateSell })];
                    case 5:
                        _c.sent();
                        this._dispatch(types_1.EventType.MatchOrders, { buy: buy, sell: sell, accountAddress: accountAddress, matchMetadata: metadata });
                        args = [
                        ...
                        data = this._wyvernProtocol.wyvernExchange.atomicMatch_.getABIEncodedTransactionData(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10]);
                        return [2 /*return*/, data];
                }
            });
        });
